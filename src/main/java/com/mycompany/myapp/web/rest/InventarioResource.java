...
public class InventarioResource {
    ...
    public ResponseEntity<Inventario> updateInventario(
        ...
        Inventario result = inventarioService.update(inventario);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, inventario.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Inventario> partialUpdateInventario(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, inventario.getId())
        );
    }
    ...
    public ResponseEntity<List<Inventario>> getAllInventarios(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
    ...
    public ResponseEntity<Inventario> getInventario(@PathVariable String id) {

...
export const getEntities = createAsyncThunk('inventario/fetch_entity_list', async ({ page, size, sort }: IQueryParams) => {
...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IInventario, thunkAPI) => {
    return axios.post<IInventario>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IInventario, thunkAPI) => {
    return axios.put<IInventario>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IInventario, thunkAPI) => {
    return axios.patch<IInventario>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<IInventario>(requestUrl);
  },
  { serializeError: serializeAxiosError }
);

...
import { getEntity, deleteEntity } from './inventario.reducer';

export const InventarioDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="itesm20220528App.inventario.delete.question">
        <Translate contentKey="itesm20220528App.inventario.delete.question" interpolate={{ id: inventarioEntity.id }}>

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECURSOSHUMANOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_RECURSOSHUMANOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECURSOSHUMANOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECURSOSHUMANOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECURSOSHUMANOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECURSOSHUMANOS actions', async () => {
      const expectedActions = [
        {
